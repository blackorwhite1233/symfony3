...
use CmsBundle\Entity\TbPages;

/**
 * Controller used to manage Pages contents in the backend.
 *
 * @Route("/admin/page")
...
class PageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pages = $entityManager->getRepository('CmsBundle:TbPages')->findAll();
        return $this->render('CmsBundle:Admin/Page:index.html.twig', array('pages' => $pages));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('CmsBundle\Form\PostType', $post)
        ...
        return $this->render('CmsBundle:Admin/Blog:new.html.twig', array(
            'post' => $post,
