...
class BlogController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $posts = $entityManager->getRepository('CmsBundle:BlogPost')->findAll();
        return $this->render('CmsBundle:Admin/Blog:index.html.twig', array('posts' => $posts));
    }
     ...
     *
     * @Route("/{id}", requirements={"id": "\d+"}, name="admin_page_show")
     * @Method("GET")
     */
